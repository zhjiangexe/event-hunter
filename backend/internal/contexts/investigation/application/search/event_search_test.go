...
func validEventSearchFilter() EventSearchFilter {
...
func (fake *eventSearchReadModelFake) Search(_ context.Context, filter EventSearchFilter) ([]ForensicsEvent, error) {
	fake.calls++
	fake.filter = filter
	return []ForensicsEvent{}, nil
}

func (fake *eventSearchReadModelFake) ProcessingSummaries(context.Context, []string) (map[string]ProcessingSummary, error) {
	return map[string]ProcessingSummary{}, nil
}
