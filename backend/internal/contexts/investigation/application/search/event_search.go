...
type EventSearchReadModel interface {
...
type EventSearchService struct {
	readModel  EventSearchReadModel
	qualifiers EventSearchQualifierRepository
}

func NewEventSearchService(readModel EventSearchReadModel, qualifiers EventSearchQualifierRepository) *EventSearchService {
	return &EventSearchService{readModel: readModel, qualifiers: qualifiers}
}

func (service *EventSearchService) Search(ctx context.Context, filter AdvancedEventSearchFilter) ([]ForensicsEvent, error) {
