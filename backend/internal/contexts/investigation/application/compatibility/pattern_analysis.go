...
type PatternEventReader interface {
...
type PatternService struct {
	...
	forensics   PatternEventReader
	eventWindow EventWindowSource
	unitOfWork  ports.UnitOfWork
	now         func() time.Time
}

func NewPatternService(cases CaseRepository, details InvestigationDetailsRepository, readModel PatternEventReader, eventWindow EventWindowSource, unitOfWork ports.UnitOfWork) *PatternService {
	if unitOfWork == nil {
