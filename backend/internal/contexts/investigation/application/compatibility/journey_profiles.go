...
type JourneyProfileQueries struct{}

func NewJourneyProfileQueries() *JourneyProfileQueries {
	return &JourneyProfileQueries{}
}
...
func (service *JourneyProfileQueries) List() []journeys.Profile {
