...
func NewService(repository ports.PatternFeedbackRepository, audit AuditWriter, unit ports.UnitOfWork) *Service {
	return &Service{repository: repository, audit: audit, unit: unit, now: time.Now}
}

func (service *Service) Reclassify(ctx context.Context, command Command) (domain.PatternFindingFeedback, error) {
