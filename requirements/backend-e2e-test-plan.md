...
目前基準為 18 個 feature、108 個 runtime scenarios；2026-08-27 的完整 suite 已通過 108/108。
...
`investigation-boundaries.feature` 目前包含 9 個 runtime scenarios，其中案件查詢新增：
...
```bash
java -jar /tmp/event-hunter-karate-2.1.1.jar run \
