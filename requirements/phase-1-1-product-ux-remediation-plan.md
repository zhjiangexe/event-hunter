...
- 狀態：`in_progress`（`P1.1-UX-01`～`P1.1-UX-04`／`EH-P1.1-013`～`EH-P1.1-016`
  已完成；`P1.1-UX-13` 的接入指南子範圍由 `EH-P1.1-017` 完成；主序列下一項仍為 `P1.1-UX-05`）
- 建立日期：`2026-08-26`
...
**狀態**：`in_progress`（接入指南子範圍 `EH-P1.1-017` 已完成）
...
- selector 尚待納入 Overview、Journey Profiles、Scenario Lab 與共用 Query Shortcuts 的獨立導覽。
- 模組選單尚待改為「使用者想回答的問題」優先，並建立可持續校驗 Available／Known gaps 的維護規則。
